...
import 'package:lab10_notif/components/chat_bubble.dart';
import 'package:lab10_notif/components/my_textfield.dart';
import 'package:lab10_notif/services/auth/auth_service.dart';
import 'package:lab10_notif/services/chat/ChatService.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    //causeing a delay for keyboard
      //amount of remaining space calculated
      //scroll down
    ...
    // wait a bit for listview and scroll to bottom
    Future.delayed(const Duration(milliseconds: 300), ()=> scrollDown(),);
